  ...
  Widget _buildNav(BuildContext context, String Function(String, {Map<String, String>? params}) t) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _navItem(LucideIcons.home, t('nav.home'), '/patient/home', context),
          _navItem(LucideIcons.fileText, t('nav.booklet'), '/patient/booklet', context),
          _centerButton(context),
          _navItem(LucideIcons.messageCircle, t('nav.chat'), '/patient/chat', context),
          _navItem(LucideIcons.user, t('nav.profile'), '/patient/profile', context),
        ],
      ),
    );
  }

  Widget _navItem(IconData icon, String label, String path, BuildContext context) {
    final isActive = currentLocation == path ||
        (path != '/patient/home' && currentLocation.startsWith(path));
